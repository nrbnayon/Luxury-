    ...
    <div className="flex flex-col lg:flex-row lg:space-x-6  justify-center">
      ...
      <div className="relative">
        ...
        <img
          src={about2}
          alt="about2"
          className="absolute top-1/3 left-1/3  md:-top-10 md:left-10 md:w-80 md:h-80 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 rounded-full border-4 border-white"
        />
      </div>
    </div>
  );
